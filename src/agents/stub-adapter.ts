...
import type { AgentRunResult, AgentSession, SharedMemoryEntry, TaskRecord } from "../types.js";
...
export class StubAgentAdapter implements AgentAdapter {
  ...
  async run(task: TaskRecord, session: AgentSession, _sessionPaths: SessionPaths, _tools: AgentTooling, _sharedMemory: SharedMemoryEntry[]): Promise<AgentRunResult> {
